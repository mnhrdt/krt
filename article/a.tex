...
\begin{proof}
	...
	Since~$g^M$ is of bounded support, there is an~$h_0>0$ such
	that~$\mathrm{supp}\left(g^M_h\right)\subseteq B_R(0)\ \forall h\le h_0$.
	...
	proposition~\ref{prp:curv1}.  Applying this proposition to the
	extended~$u$ and~$g^M$, we have
